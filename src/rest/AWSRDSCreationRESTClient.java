...
public class AWSRDSCreationRESTClient {
	public String ClientGetCall (String DBType, String DBInstanceName, String MasterUserName, String MasterPassword) throws Exception{
		URI uri = new URI("http", "//34.217.134.45:8080/CloudCaptain/DB/create/" + DBType +"/"+ DBInstanceName+"/" + MasterUserName + "/" + MasterPassword, null);		
		URL url = uri.toURL();
	    ...
	    try{
				...
				System.out.println("Hello after coming from RDS Creation API");
