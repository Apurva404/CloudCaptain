...
public enum UserGCPDBRequestTable {
	...
	UserGCPDBRequestTable(int colIndex, String colName, String colType) {
   	...
   	public static String getTableName() { return "UserGCPDBRequest"; }
}
