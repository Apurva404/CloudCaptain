...
public enum UserGCPDBResponseTable {
	...
	UserGCPDBResponseTable(int colIndex, String colName, String colType) {
   	...
   	public static String getTableName() { return "UserGCPDBResponse"; }
}
